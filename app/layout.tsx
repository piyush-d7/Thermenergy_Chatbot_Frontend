...
// --- TYPE DEFINITION ---
// We define the type for the component's props.
// 'children' is a standard React property, its type is React.ReactNode.
interface RootLayoutProps {
children: React.ReactNode;
}
export default function RootLayout({ children }: RootLayoutProps) { // <-- Apply the type here
// --- STATE DEFINITION ---
// We explicitly type the state as a DOM Element or null.
